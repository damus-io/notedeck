...
# Title for contacts column
Contacts_248f = {"["}Çóñtàçts{"]"}

# Display name for contact lists
Contacts_5231 = {"["}Çóñtàçts{"]"}
...
# Name of the demo deck feed
Demo_Deck_bb54 = {"["}Démó Déçk{"]"}
...
See_notes_from_your_contacts_ef0a = {"["}Séé ñótés fróm yóúr çóñtàçts{"]"}
