...
Add_private_relay_de9d = Add private relay
...
name__zapped_a_note_you_were_tagged_in_a6e2 = {$name} zapped a note you were tagged in

# zap from user to your note
name__zapped_your_note_45d1 = {$name} zapped your note
...
name__and__count__others_zapped_a_note_you_were_tagged_in_985d =
    { $count ->
        [one] {$name} and {$count} other zapped a note you were tagged in
       *[other] {$name} and {$count} others zapped a note you were tagged in
    }
