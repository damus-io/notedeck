...
impl Timeline {
    ...
    pub fn poll_notes_into_view(
        ...
        // Front inserts usually mean a new notification-worthy note; a
        // non-front insert is usually older history sliding into the timeline.
        // This is intentionally a heuristic: a new note can still land just
        // behind the current latest entry.
        if any_front_insert {
