...
use egui::{emath::TSTransform, LayerId, Rect, Response, Sense, Ui, UiBuilder, Vec2};
...
impl PanZoomArea {
    ...
    /// Show the [`PanZoomArea`], and add the contents to the viewport.
    ///
