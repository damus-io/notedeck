use crate::{
    frame_history::FrameHistory, i18n::LocalizationContext, wallet::GlobalWallet, zaps::Zaps,
    Accounts, Args, DataPath, Images, JobPool, NoteCache, ThemeHandler, UnknownIds,
};
