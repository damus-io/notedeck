use crate::{
    ...
    namecoin::NamecoinResolver, nip05::Nip05Cache, wallet::GlobalWallet, zaps::Zaps, Args,
    DataPath, Images, JobPool, MediaJobs, NoteCache, RemoteApi, SettingsHandler, UnknownIds,
};
...
pub struct AppContext<'a> {
    ...
    pub namecoin_resolver: &'a mut NamecoinResolver,
